...
## Activity
1. build from our analyses and calculate the median lobster size for each site and year (hint: `size_mm` and function called `median()`)
2. create a ggplot and save. For example: 
ggplot(data = siteyear_summary, aes(x = year, y = median))
3. sync to github
